...
\notebox{\textbf{Note:} Although we are giving you the grading software, the data set that will be used to grade you is different from the data set that we are giving you in this software.s}
