...
\warningbox{
    \textbf{Warning:}
    Connecting multiple devices to your PiCar is possible; although, if your PiCar recives multiple steering / driving instructions at the same time, it will  stop responding.
}
